...
import { BaileysEventEmitter, BaileysEventMap, WACallUpdateType, WAVersion } from '@whiskeysockets/baileys/lib/Types';
...
export declare const bindWaitForConnectionUpdate: (ev: BaileysEventEmitter) => (check: (u: Partial<import("@whiskeysockets/baileys/lib/Types").ConnectionState>) => boolean | undefined, timeoutMs?: number) => Promise<void>;
